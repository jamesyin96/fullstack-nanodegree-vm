from restaurant_geo_search import findARestaurant
...
google_api_key = 'AIzaSyBiZ7qsZOq8OUsnkUQIgPe4nf0OwwqCXgw'
...
def all_restaurants_handler():
    if request.method == 'GET':
        ...
        if restaurant_info != "No Restaurants Found":
            ...
            return jsonify({"error": "No Restaurants Found for %s in %s" %
                           (mealType, location)})
